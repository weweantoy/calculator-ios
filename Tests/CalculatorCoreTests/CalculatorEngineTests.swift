...
final class CalculatorEngineTests: XCTestCase {
    ...
    func testSin30Degrees() throws {
        ...
        XCTAssertEqual(result, Decimal(0.5), accuracy: 0.0001)
    }
    ...
    func testTan45Degrees() throws {
        ...
        XCTAssertEqual(result, Decimal(1), accuracy: 0.0001)
    }
    ...
    func testLog10() throws {
        ...
        XCTAssertEqual(result, Decimal(2), accuracy: 0.0001)
    }
    ...
    func testComplexExpression1() throws {
        ...
        XCTAssertEqual(result, Decimal(string: "11.5"), accuracy: 0.0001)
    }
    ...
    func testComplexExpression2() throws {
        ...
        XCTAssertEqual(result, Decimal(7), accuracy: 0.0001)
    }
    ...
    func testAngleUnitSwitch() throws {
        ...
        XCTAssertEqual(a, Decimal(1), accuracy: 0.0001)
        XCTAssertEqual(b, Decimal(1), accuracy: 0.0001)
    }
}
